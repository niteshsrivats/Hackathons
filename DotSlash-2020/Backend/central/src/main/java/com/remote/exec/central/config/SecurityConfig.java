...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final AuthenticationService authorizationEntityService;
    private final JwtAuthenticationEntryPoint unauthorizedHandler;
    private final RequestEncapsulatingFilter jwtAuthenticationFilter;

    @Autowired
    public SecurityConfig(AuthenticationService authorizationEntityService, JwtAuthenticationEntryPoint unauthorizedHandler, RequestEncapsulatingFilter jwtAuthenticationFilter) {
